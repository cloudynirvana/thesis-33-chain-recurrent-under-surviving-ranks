...
<head>
<meta charset="utf-8"/>
<title>Thesis #33. Chain-recurrent labels under surviving multi-channel ranks</title>
<style>
@page {{
  size: A4;
  margin: 22mm 20mm 24mm 20mm;
  @bottom-center {{
    content: "Ogbonna KE. Thesis #33. Computational research only. Not a medical device. " counter(page);
    font-size: 8.5pt;
    color: #444;
